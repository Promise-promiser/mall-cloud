...
import com.sql.cloud.mall.practice.cartorder.model.dao.OrderItemMapper;
import com.sql.cloud.mall.practice.cartorder.model.dao.OrderMapper;
import com.sql.cloud.mall.practice.cartorder.model.pojo.Order;
import com.sql.cloud.mall.practice.cartorder.model.pojo.OrderItem;
import com.sql.cloud.mall.practice.cartorder.model.request.CreateOrderReq;
import com.sql.cloud.mall.practice.cartorder.model.vo.CartVO;
import com.sql.cloud.mall.practice.cartorder.model.vo.OrderItemVO;
import com.sql.cloud.mall.practice.cartorder.model.vo.OrderVO;
import com.sql.cloud.mall.practice.cartorder.service.CartService;
import com.sql.cloud.mall.practice.cartorder.service.OrderService;
import com.sql.cloud.mall.practice.cartorder.util.OrderCodeFactory;
...
import com.sql.cloud.mall.practice.utils.QRCodeGenerator;
...
public class OrderServiceImpl implements OrderService {
    ...
    public String create(CreateOrderReq createOrderReq) {
        ...
        for (int i = 0; i < cartVOList.size(); i++) {
            ...
            if (cartVO.getSelected().equals(Constant.Cart.CHECKED)) {//CHECKED:商品已勾选
    ...
    public String qrcode(String orderNo){
        ...
        String address = ip + ":" + port;//request.getLocalPort()拿到端口号
        //传入到二维码里的数据
        String payUrl = "http://" + address + "/cart-order/pay?orderNo = " + orderNo;
        try {
            QRCodeGenerator.generateQRCodeImages(payUrl,350,350, FILE_UPLOAD_DIR + orderNo + ".png");
    ...
    public void finish(String orderNo){
        ...
        //如果是普通用户，就要校验订单的所属;首先是普通用户&& userId和你的userId不一样 --> 抛出异常，不是你的订单
